...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          beforeEach(async () => {
              ...
              //   deployer = accounts[0]
              player = accounts[1]
              await deployments.fixture(["mocks", "all"]) // Deploys modules with the tags "mocks" and "raffle"
          ...
          describe("performUpkeep", function () {
              ...
              it("updates the raffle state and emits a requestId", async () => {
                  ...
                  assert(raffleState.toNumber() == 1) // 0 = open, 1 = calculating
              })
          })
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets, and sends money", async () => {
                  ...
                  const startingTimeStamp = await raffle.lastLotteryTime() // stores starting timestamp (before we fire our event)
                  ...
                  await new Promise(async (resolve, reject) => {
                      raffle.once("WinnerPicked", async () => {
                          ...
                          try {
                              ...
                              const endingTimeStamp = await raffle.lastLotteryTime()
